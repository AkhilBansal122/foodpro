					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">AboutUs Details</li>
							</ol>
						</nav>
					</div>
				</div>
                ...
                <div class="card">
							<div class="card-header custom_col">
									<div class="col-md-2 filter_btn_div">
										<a href="{{route('restaurent.aboutus.create')}}" class="btn btn-primary px-5 radius-0">Add New</a>
									</div>
							</div>
						</div>
...
<script type="text/javascript">
  $(function () {
        ...
        retrieve:true,
        ajax: {
          url: "{{ route('restaurent/aboutus/data') }}",
            data: function (d) {
