				...
				<div class="card">
					...
					<div class="card-body">
						...
						@include('flash-message')
							<form enctype='multipart/form-data' action="{{route('restaurent.banner.store')}}" method="post">
							@csrf
                            <div class="bacic-info mb-3">
    <h4 class="mb-3">Basic info</h4>
    <div class="row">
        <div class="col-xl-3">
            <label class="form-label">Banner Name: <span style="color:red">*</span></label>
            <input type="text" class="form-control mb-3" required readonly name="name"
                value="{{ isset($data->name) ? $data->name : '' }}" placeholder="Enter Banner Name">
            @if ($errors->has('name'))
...
<div class="Security">
    <div class="row">
        <div class="col-xl-12">
            <a href="{{ route('restaurent.banner') }}" class="btn btn-outline-primary float-end ms-3">Back</a>
        </div>
    </div>
</div>
